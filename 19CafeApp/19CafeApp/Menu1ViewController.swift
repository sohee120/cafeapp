...
let messages: Array<String> = ["윤다방만의 맛과 향을 더한 100% 아라비카 로스팅 원두로 뽑아내 깊고 진한 맛의 앗!메리카노",
                               "시원달콤한 윤다방 대표메뉴, 믹스커피 종결자!",
                               ...
                               "달달하고 향긋한 베트남식 연유라떼",
                               "진한 에스프레소와 시원한 우유가 어우려져 탄생한 부드러운 윤다방 라떼",
                               "다크한 초콜렛과 진한 에스프레소, 부드러운 우유가 더해진 달콤한 맛의 커피",
                               "카라멜소스와 신선한 우유, 에스프레소로 맛을 낸 달콤한 윤다방 인기메뉴",
